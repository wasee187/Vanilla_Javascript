...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _http__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./http */ \"./src/http.js\");\n/* harmony import */ var _ui__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ui */ \"./src/ui.js\");\n//importing http module \n //importing UI module\n\n //getting Tasks after DOM loaded\n\ndocument.addEventListener('DOMContentLoaded', getTasks); //Eidt task/complete task event listener\n\ndocument.querySelector('.task-continer').addEventListener('click', stateCheck); //update task eventlistener\n\ndocument.querySelector('.update-task').addEventListener('click', updateTask); //add task event listener taskhhandle\n\ndocument.querySelector('.add-Task').addEventListener('click', addTask); //Delete task event listener\n\ndocument.querySelector('.delete-task').addEventListener('click', deleteTask); //back button event listener\n\ndocument.querySelector('.back-btn').addEventListener('click', backState); //function fo completed tasks\n\nfunction completedTaskCount(e) {\n  var taskID = e.target.parentElement.id.split('-')[1];\n  console.log(taskID);\n} //function for check state\n\n\nfunction stateCheck(e) {\n  //event deligation\n  if (e.target.parentElement.classList.contains('Edit-task')) {\n    editTask(e);\n  } else if (e.target.parentElement.classList.contains('completed-task')) {\n    completedTaskCount(e);\n  }\n} //function for back state\n\n\nfunction backState() {\n  //clearing field\n  _ui__WEBPACK_IMPORTED_MODULE_1__[\"ui\"].clearFiled(); //getting task\n\n  getTasks();\n} //function for delete task\n\n\nfunction deleteTask(e) {\n  var taskID = document.getElementById('id').value;\n  _http__WEBPACK_IMPORTED_MODULE_0__[\"http\"][\"delete\"](\"http://localhost:3000/Tasks/\".concat(taskID)).then(function (task) {\n    //clearing field\n    _ui__WEBPACK_IMPORTED_MODULE_1__[\"ui\"].clearFiled(); //getting task\n\n    getTasks();\n  });\n} //function for update task\n\n\nfunction updateTask(e) {\n  e.preventDefault();\n  var taskTitle = document.querySelector('.task-title').value;\n  var taskID = document.getElementById('id').value;\n\n  if (taskTitle.trim() === '') {\n    console.log(\"Please enter valid informations\");\n  } else {\n    var updatedTask = {\n      title: taskTitle,\n      complete: false\n    };\n    _http__WEBPACK_IMPORTED_MODULE_0__[\"http\"].update(\"http://localhost:3000/Tasks/\".concat(taskID), updatedTask).then(function (task) {\n      //clearing form field\n      _ui__WEBPACK_IMPORTED_MODULE_1__[\"ui\"].clearFiled(); //getting data\n\n      getTasks();\n    });\n  }\n} //function for edit task\n\n\nfunction editTask(e) {\n  _ui__WEBPACK_IMPORTED_MODULE_1__[\"ui\"].showEidtState();\n  var id = e.target.parentElement.id.split('-')[1];\n  _http__WEBPACK_IMPORTED_MODULE_0__[\"http\"].get(\"http://localhost:3000/Tasks/\".concat(id)).then(function (data) {\n    _ui__WEBPACK_IMPORTED_MODULE_1__[\"ui\"].fillForm(data);\n  });\n} //function for add new Task\n\n\nfunction addTask(e) {\n  e.preventDefault();\n  var taskTitle = document.querySelector('.task-title').value;\n  var taskID = document.getElementById('id').value;\n\n  if (taskTitle.trim() === '') {\n    console.log('Please enter valid information');\n  } else {\n    var data = {\n      title: taskTitle,\n      complete: false\n    };\n    _http__WEBPACK_IMPORTED_MODULE_0__[\"http\"].post('http://localhost:3000/Tasks', data).then(function (data) {\n      _ui__WEBPACK_IMPORTED_MODULE_1__[\"ui\"].clearFiled();\n      getTasks();\n    });\n  }\n} //getting tasks to UI\n\n\nfunction getTasks() {\n  _http__WEBPACK_IMPORTED_MODULE_0__[\"http\"].get('http://localhost:3000/Tasks').then(function (tasks) {\n    //showing tasks in ui\n    _ui__WEBPACK_IMPORTED_MODULE_1__[\"ui\"].showTasks(tasks); //showing total task in ui\n\n    _ui__WEBPACK_IMPORTED_MODULE_1__[\"ui\"].showTotalTasks(tasks);\n  })[\"catch\"](function (err) {\n    return console.log(err);\n  }); //showing add State\n\n  _ui__WEBPACK_IMPORTED_MODULE_1__[\"ui\"].showAddState();\n}\n\n;\n\n//# sourceURL=webpack:///./src/index.js?");
